    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-gray-800">Total Rides</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-gray-800">RIDE Tokens</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center gap-2">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-gray-800">Total Spent</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center gap-2">
            ...
            <CardContent>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-800">{activeRide.ride.pickupAddress}</p>
                </div>
                <div>
                  <p className="font-semibold">Dropoff:</p>
                  <p className="text-gray-800">{activeRide.ride.dropoffAddress}</p>
                </div>
                <div>
        ...
        <Card>
          ...
          <CardContent>
            {riderRides.length === 0 ? (
              <p className="text-gray-800">No rides yet. Book your first ride to get started!</p>
            ) : (
              <div className="space-y-4">
                {riderRides.slice(0, 10).map((ride) => (
                  <div key={ride.id} className="flex justify-between items-center border-b pb-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-800">to {ride.dropoffAddress}</p>
